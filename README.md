...
Ядро также упрощает ранний экран загрузки Forge до одной плавной полосы
прогресса в спокойной светлой палитре. После первой установки цвета можно
изменить в `config/splash.properties`.
